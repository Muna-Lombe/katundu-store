...
const CartIco = ({size, isBurgerMenu,isCartBtn=false}) => {
  ...
  return (
    ...
    <div id="border_circle" className={"p-2 less-than-xs:p-[0.3rem] max-w-[1.8rem] h-[1.6rem]  relative sm:flex md:flex lg:flex border-[0.9px] border-[#727280] rounded-[2rem] flex justify-center items-center"} >
