...
const BasketIco = ({strokeColor="black",isBurgerMenu}) => {
  ...
  return (
   <span className='w-max'>
     ...
     {/* isBurgerMenu ? burger_menu : base */}
      <svg className={(isBurgerMenu ? burger_menu : base)+" stroke-current group-hover:stroke-white"} viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
