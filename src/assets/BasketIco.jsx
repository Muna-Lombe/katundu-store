...
const BasketIco = ({strokeColor="black"}) => {
  ...
  return (
   <span className=''>
      <svg className={"less-than-sm:w-[16px] less-than-sm:aspect-square w-[21px] h-[19px] stroke-current group-hover:stroke-white"} viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
