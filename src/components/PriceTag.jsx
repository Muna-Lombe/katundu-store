  ...
  return (
    <div className="price-tag my-2">
      ...
      </div>
      {
        discount 
        ?
          <p className="price-note w-full  px-2  flex flex-row whitespace-nowrap justify-center items-center  gap-1 bg-green-500 rounded-xl text-white font-[arial] font-medium less-than-xs:child:text-sm">
